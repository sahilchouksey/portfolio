...
#exp(
  ...
  details: [
    ...
    - *Whisp Landing Page*: Optimized UI with *Tailwind CSS*, improved load time by *50%* (4s to 2s)
  ]
)
...
#exp(
  ...
  details: [
    - *Doct App*: Built healthcare platform with *Golang/GIN*, *Next.js 13*, *PostgreSQL*, achieving *4X faster APIs*
    - Implemented role-based access control, encrypted database entries for healthcare compliance
    - Developed patient document management with S3 integration, enabling progress monitoring
    ...
    - *Pose Detection*: Developed CNN and MediaPipe solution for posture analysis with custom datasets
  ]
)
